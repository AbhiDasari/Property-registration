...
echo
echo "Deploying Chaincode On Property Registration Network"
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
...
echo "Installing chaincode on peer2.users.property-registration-network.com.com ..."
installChaincode 2 'users' $VERSION

# Instantiate chaincode on the channel using peer0.registrar and peer0.users
echo "Instantiating chaincode on channel using peer0.registrar.property-registration-network.com.com ..."
instantiateChaincode 0 'registrar' $VERSION "registrar"

echo "Instantiating chaincode on channel using peer0.users.property-registration-network.com.com ..."
instantiateChaincode 0 'users' $VERSION "users"

echo
echo "========= All GOOD, Chaincode Is Now Installed & Instantiated On Registration Network =========== "
echo
